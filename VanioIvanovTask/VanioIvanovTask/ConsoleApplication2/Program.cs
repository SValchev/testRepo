    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ()
            {
                ...
                {
                    Console.WriteLine(
                        $"{currentRow + 1}. | {string.Join(" | ", matrix[currentRow])} | Row sum = {sumOfRows[currentRow]}");
                }
            ...
            currentColum)
            {
                ...
                for (int i = 1; i < matrix.Length; i++)
                {
                    ...
                    if (matrix[currentRow][currentColum] >= matrix[i][currentColum] && usedColums[currentColum] < 2 &&
                        usedRows[i] < 1)
                    {
                        currentRow = i;
                    }
